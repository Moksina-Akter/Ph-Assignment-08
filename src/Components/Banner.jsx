    ...
    return (
        <>
            <div className=" max-w-7xl mx-auto space-y-5">
                ...
                <p className='text-xl text-center text-gray-600'>At HERO.IO, we craft innovative apps designed to make everyday life simpler, smarter, and more exciting. <br /> Our goal is to turn your ideas into digital experiences that truly make an impact. </p>
